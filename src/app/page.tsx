  ...
  return (
    <main className="min-h-screen p-6">
      <div className="mx-auto max-w-5xl">
        <div className="mt-6 ml-6 w-40">
          <Image src="/head_logo.png" alt="Face Massage" width={200} height={80} className="h-auto w-full" priority />
        </div>
        <BrandHeader />
        <div className="mt-8 grid gap-6 lg:grid-cols-[360px_minmax(0,_1fr)]">
          ...
          <div className="space-y-4 lg:max-w-sm">
            <Card title="Service" className="max-w-sm">
            ...
            {selectedSlot && (
              <Card title="Booking" className="max-w-sm">
